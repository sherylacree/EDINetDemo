...
public class PurchaseOrder_850 {
    ...
    public char Component_Element_Seperator { get; internal set; }
    ...
    public class FunctionalGroup {
        ...
        public string ApplicaitonReceiverCode { get; internal set; }
    }
    ...
    public class OrderDetail {
        ...
        public string BuyersPartNumber { get; internal set; }
    }
